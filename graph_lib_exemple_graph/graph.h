...
class Vertex
{
    ...
    public:
        ...
        //void pre_update(std::ifstream &fichier);
        void post_update(std::ofstream &fichier);
};
...
class Graph
{
    friend class Bibli_graphe;
    friend class Bibli_arc;
    private :
    ...
    public:
        ...
        //void add_interfaced_vertex(std::ifstream &fichier, int idx=0, double value, int x, int y, std::string pic_name="", int pic_idx=0 );
        ...
        void make_example(std::ifstream &fichier, std::ifstream &fichier2);//,int idx, double value, int x, int y, std::string pic_name, int pic_idx);

        /// La méthode update à appeler dans la boucle de jeu pour les graphes avec interface

        //void pre_update(std::ifstream &fichier1, std::ifstream &fichier2);
        void post_update(std::ofstream &fichier1, std::ofstream &fichier2);
};
