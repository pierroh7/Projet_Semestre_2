...
void Graph::test_save_coords()
{
    ...
    if(graphe1)
    {
        ...
        {
            graphe1 << i << " " << m_vertices[i].m_value << " " << m_vertices[i].m_interface->m_top_box.get_posx() << " " << m_vertices[i].m_interface->m_top_box.get_posy()
    ...
    if(arc1)
    {
        ...
        {
            arc1 << i << " " << m_edges[i].m_from << " " << m_edges[i].m_to << " " << m_edges[i].m_interface->m_slider_weight.get_value() << std::endl;
        }
