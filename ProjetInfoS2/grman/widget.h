...
class WidgetImage : public Widget
{
    protected :
        ...
        bool m_img_state = true; ///Pour savoir si on doit écrire le sommet dans le fichier
    ...
    public :
        ...
        ///Gestion de l'existence des arcs et des sommets
        void set_img_state (bool img_state) {m_img_state=img_state;};
        bool get_img_state () {return m_img_state;};
};
...
class WidgetEdge : public Widget
{
    protected :
        ...
        bool m_arc_state = true; ///Pour savoir si on doit écrire l'arc dans le fichier
    ...
    public :
        ...
        void set_arc_state (bool arc_state) {m_arc_state=arc_state;};
        bool get_arc_state () {return m_arc_state;};
};
